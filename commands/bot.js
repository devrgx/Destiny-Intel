...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const invite = new EmbedBuilder()
      ...
      .setURL('https://discord.com/oauth2/authorize?client_id=1367825593114038272&permissions=964220546240&integration_type=0&scope=bot')
      .setDescription('You can add the Bot to your own Server, just click [here](https://discord.com/oauth2/authorize?client_id=1367825593114038272&permissions=964220546240&integration_type=0&scope=bot).')
      .setColor(0x0099ff)
      .setFooter({
      ...
      .setDescription('You can join the Bots support Server by clicking [here](https://discord.gg/wgSFPBuRhF).')
      .setColor(0x0099ff)
      .setFooter({
        text: `Destiny Intel | v ${data.version}`,
        iconURL: "https://i.imgur.com/cVoKfFP.png",
